...
-keep class com.neon.android.protocol.** { *; }
-keep class com.neon.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.neon.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.neon.android.favorites.** { *; }
-keep class com.neon.android.nostr.** { *; }
-keep class com.neon.android.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.neon.android.net.RealTorProvider { *; }
