...
class FileTransferTest {
    ...
    fun `replaceFilePathInContent should correctly format content markers for different file types`() {
        ...
        val imageMessage = BitchatMessage(
            ...
            content = "/data/user/0/com.neon.android/files/images/photo.jpg",
        ...
        val audioMessage = BitchatMessage(
            ...
            content = "/data/user/0/com.neon.android/files/audio/voice.amr",
        ...
        val fileMessage = BitchatMessage(
            ...
            content = "/data/user/0/com.neon.android/files/documents/document.pdf",
        ...
        result = result.replace(
            "/data/user/0/com.neon.android/files/images/photo.jpg",
            "[image] photo.jpg"
        )
