...
import com.neon.android.nostr.GeohashMessageHandler
import com.neon.android.nostr.GeohashRepository
import com.neon.android.nostr.NostrDirectMessageHandler
import com.neon.android.nostr.NostrIdentityBridge
import com.neon.android.nostr.NostrProtocol
import com.neon.android.nostr.NostrRelayManager
import com.neon.android.nostr.NostrSubscriptionManager
import com.neon.android.nostr.PoWPreferenceManager
import com.neon.android.nostr.GeohashAliasRegistry
import com.neon.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.neon.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.neon.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.neon.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.neon.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.neon.android.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.neon.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.neon.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.neon.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.neon.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.neon.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.neon.android.geohash.ChannelID.Mesh -> {
            ...
            is com.neon.android.geohash.ChannelID.Location -> {
