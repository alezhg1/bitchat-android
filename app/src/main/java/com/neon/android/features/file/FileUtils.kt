package com.neon.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.neon.android.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.neon.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.neon.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.neon.android.model.BitchatMessageType.Audio
            else -> com.neon.android.model.BitchatMessageType.File
        }
    }
