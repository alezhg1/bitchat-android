package com.neon.android.noise

import android.content.Context
import android.util.Log
import com.neon.android.identity.SecureIdentityStateManager
import com.neon.android.mesh.PeerFingerprintManager
import com.neon.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.neon.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.neon.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.neon.android.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.neon.android.protocol.BitchatPacket): com.neon.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.neon.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
