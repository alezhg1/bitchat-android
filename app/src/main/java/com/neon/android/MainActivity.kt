...
import com.neon.android.onboarding.BluetoothCheckScreen
import com.neon.android.onboarding.BluetoothStatus
import com.neon.android.onboarding.BluetoothStatusManager
import com.neon.android.onboarding.BatteryOptimizationManager
import com.neon.android.onboarding.BatteryOptimizationPreferenceManager
import com.neon.android.onboarding.BatteryOptimizationScreen
import com.neon.android.onboarding.BatteryOptimizationStatus
import com.neon.android.onboarding.BackgroundLocationPermissionScreen
import com.neon.android.onboarding.InitializationErrorScreen
import com.neon.android.onboarding.InitializingScreen
...
import com.neon.android.onboarding.PermissionManager
import com.neon.android.ui.ChatScreen
import com.neon.android.ui.ChatViewModel
import com.neon.android.ui.OrientationAwareActivity
import com.neon.android.util.LocaleUtils
import android.content.Context
import com.neon.android.ui.theme.BitchatTheme
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.neon.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.neon.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.neon.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.neon.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        try { com.neon.android.service.MeshForegroundService.start(applicationContext) } catch (_: Exception) { }
        meshService = com.neon.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.neon.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.neon.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.neon.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.neon.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.neon.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.neon.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.neon.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.neon.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.neon.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.neon.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.neon.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.neon.android.geohash.GeohashChannelLevel.REGION
                        else -> com.neon.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.neon.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.neon.android.geohash.ChannelID.Location(geohashChannel)
