...
import com.neon.android.util.AppConstants
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.*
import kotlinx.coroutines.Job
import com.neon.android.ui.debug.DebugSettingsManager
import com.neon.android.ui.debug.DebugScanResult
...
class BluetoothGattClientManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!com.neon.android.ui.debug.DebugSettingsManager.getInstance().gattClientEnabled.value) {
    ...
    fun onScanStateChanged(shouldScan: Boolean) {
        val enabled = try { com.neon.android.ui.debug.DebugSettingsManager.getInstance().gattClientEnabled.value } catch (_: Exception) { true }
    ...
    private fun handleScanResult(result: ScanResult) {
        ...
        val dbg = try { com.neon.android.ui.debug.DebugSettingsManager.getInstance() } catch (_: Exception) { null }
