...
import com.neon.android.model.BitchatFilePacket
...
import com.neon.android.model.PrivateMessagePacket
import com.neon.android.protocol.BitchatPacket
import com.neon.android.services.SeenMessageStore
import com.neon.android.ui.ChatState
import com.neon.android.ui.MeshDelegateHandler
import com.neon.android.ui.PrivateChatManager
    ...
    fun onGiftWrap(giftWrap: NostrEvent, geohash: String, identity: NostrIdentity) {
        scope.launch(Dispatchers.Default) {
            try {
                ...
                if (packet.type != com.neon.android.protocol.MessageType.NOISE_ENCRYPTED.value) return@launch
                ...
                com.neon.android.nostr.GeohashAliasRegistry.put(convKey, senderPubkey)
        ...
        when (payload.type) {
            ...
            NoisePayloadType.FILE_TRANSFER -> {
                ...
                if (file != null) {
                    ...
                    val savedPath = com.neon.android.features.file.FileUtils.saveIncomingFile(application, file)
                    val message = BitchatMessage(
                        id = uniqueMsgId,
                        sender = senderNickname,
                        content = savedPath,
