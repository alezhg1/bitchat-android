package com.neon.messenger.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.neon.messenger.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.neon.messenger.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.neon.messenger.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.neon.messenger.model.BitchatMessageType.Audio
            else -> com.neon.messenger.model.BitchatMessageType.File
        }
    }
