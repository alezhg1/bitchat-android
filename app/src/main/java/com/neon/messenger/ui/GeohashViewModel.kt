...
import com.neon.messenger.nostr.GeohashMessageHandler
import com.neon.messenger.nostr.GeohashRepository
import com.neon.messenger.nostr.NostrDirectMessageHandler
import com.neon.messenger.nostr.NostrIdentityBridge
import com.neon.messenger.nostr.NostrProtocol
import com.neon.messenger.nostr.NostrRelayManager
import com.neon.messenger.nostr.NostrSubscriptionManager
import com.neon.messenger.nostr.PoWPreferenceManager
import com.neon.messenger.nostr.GeohashAliasRegistry
import com.neon.messenger.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.neon.messenger.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.neon.messenger.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel com.neon.messenger.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.neon.messenger.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.neon.messenger.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.neon.messenger.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.neon.messenger.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.neon.messenger.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.neon.messenger.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.neon.messenger.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.neon.messenger.geohash.ChannelID.Mesh -> {
            ...
            is com.neon.messenger.geohash.ChannelID.Location -> {
