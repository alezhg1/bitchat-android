...
import com.neon.messenger.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.neon.messenger.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.neon.messenger.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.neon.messenger.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.neon.messenger.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource com.neon.messenger.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.neon.messenger.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.neon.messenger.ui.debug.DebugSettingsSheet(
