...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if ( com.neon.messenger.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { com.neon.messenger.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
