...
| **Роли** | Ученик — без ключа. Учитель и админ — секретный ключ при входе. |
...
*Документ v1.2.0 — ветка `feat/messenger-roles-geolocation`. При мерже в main обновите версию и changelog.*
